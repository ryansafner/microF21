...
- .hi-purple[Modeling] markets, individuals (consumers & firms), economies
    ...
    - ECON 305: Macroeconomic Analysis<sup>.magenta[†]</sup>
]
...
.center[
![:scale 70%](../images/micro_website_f21.png)
...
- `r fa("slack", fill ="#5E81AC")` Slack channel `#c-306-micro`
...
.center[
![:scale 100%](../images/micro_flowchart_blankbg.png)
]
