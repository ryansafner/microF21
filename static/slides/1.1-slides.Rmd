...
- Not trying to scare you! (I'd rather say this now than after Exam 1.)
...
- Office hours: Tu/Th 3:30-5:00 PM on Zoom
  - `r fa("video", fill ="#5E81AC")` <i class="fas fa-video"></i> Zoom link in Blackboard's `LIVE CLASS SESSIONS` link
...
- We will have .hi-purple[synchronous] sessions on **<i class="fas fa-video"></i> Zoom**
  - Section 1: Mon/Wed 2:00-3:15 PM
  - Section 2: Tu/Thu 2:00-3:15 PM
...
- All graded assignments are .hi-turquoise[asynchronous]
  - Submitted on Blackboard by 11:59 PM Sundays
  - Timed exams on Blackboard
...
.pull-right[
.center[
![](../images/micro_website_s21.png)
]
]

.center[
[microS21.classes.ryansafner.com](https://microS21.classes.ryansafner.com)
]
...
- See the [resources page](http://microS21.classes.ryansafner.com/resources) for more
]
