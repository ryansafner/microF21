...
.bg-washed-blue--dark-blue.ba.bw2.br3.shadow-5.ph4.mt5[
...
.pull-left[
- If I take away one friend nearby, how many more $ft^2$ would you need to keep you satisfied?
...
- .hi[Marginal Rate of Substitution (MRS)]: rate at which you trade off one good for more of the other and remain *indifferent*

- Think of this as the .hi-purple[relative value] you place on x:
...
- **Foreshadowing**: what if they are *different*? Are you truly optimizing?
]
...
- .hi-red[Math (calculus)]: "*marginal*" means "*derivative with respect to*"
...
> “I am willing to give up $\left(\frac{MU_x}{MU_y}\right)$ units of $y$ to consume 1 more unit of $x$ and stay satisfied.”
