---
title: "2.2 — Production in the Short Run & Long Run — Class Content"
draft: false
linktitle: "2.2 — Production in the Short Run & Long Run"
date: "2020-06-08"
menu:
  content:
...
{{% alert warning %}}
[Problem Set 3](/assignments/03-problem-set) is due by Wednesday October 13.
{{% /alert %}}
...
## Problem Set 3 Due Wed Oct 13

[Problem set 3](/assignments/03-problem-set) (on classes 2.1-2.3) is due by the end of the day Wednesday, October 13 by PDF upload to Blackboard Assignments.
...
$$\begin{align*}
MP_l \Delta l+MU=P_k\Delta k&= \Delta q && \text{Measuring change in output} \\
MP_l \Delta l+MU=P_k\Delta k&=0 && \text{But change in output is 0}\\
