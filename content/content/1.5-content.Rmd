...
{{% alert warning %}}
[Problem Set 1](/assignments/01-problem-set) is due by *Monday, September 13*. See the [instructions](/assignments/problem-sets) for completing homeworks.
{{% /alert %}}
...
### Problem Set 1 Due Mon September 13

[Problem set 1](/assignment/01-problem-set) (on 1.1-1.4) is by **Monday** September 13.